...
@section('titulo') Panel de control - Crear Producto
@endsection

@section('informacion')
<h1 class="my-2">Nuevo Producto</h1>
<p>En esta seccion puedes crear un nuevo producto</p>
@endsection

@section('contenido')
<h2 class="my-5">Crea un producto</h2>
